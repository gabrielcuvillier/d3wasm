...
#else
idCVar idSoundSystemLocal::s_showLevelMeter( "s_showLevelMeter", "0", CVAR_SOUND | CVAR_BOOL | CVAR_ROM, "" );
#endif
...
idCVar idSoundSystemLocal::s_force22kHz( "s_force22kHz", "0", EM_CVAR_FLAGS(CVAR_SOUND | CVAR_BOOL), ""  );
